create TABLE IF NOT EXISTS theme_header (
    ...
    theme_image JSONB NOT NULL,
    theme_label_list JSONB NOT NULL,
    theme_dataset_list JSONB NOT NULL,
    theme_custom_list JSONB NOT NULL,
    theme_tag_list JSONB NOT NULL,
    theme_other_setting JSONB NOT NULL,
    seq	INTEGER,
